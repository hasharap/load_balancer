...
static float VoltA[WINDOW_SIZE];
float VoltB[WINDOW_SIZE];
static float VoltLagA[WINDOW_SIZE];
float VoltLagB[WINDOW_SIZE];
static float VoltLeadA[WINDOW_SIZE];
float VoltLeadB[WINDOW_SIZE];



static float I1A[WINDOW_SIZE];
float I1B[WINDOW_SIZE];
static float I2A[WINDOW_SIZE];
float I2B[WINDOW_SIZE];
static float I3A[WINDOW_SIZE];
float I3B[WINDOW_SIZE];
